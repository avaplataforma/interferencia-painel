...
$avaEnrollmentReleaser=new AvaEnrollmentReleaser($avaConnections,$moodleIntegrations,$moodleRepository,$studentEnrollments,$organizationPoles,(string)$config->get('app.ava_auto_release_from'));
