...
$tests['prepara fluxo unificado de matrículas'] = static function () use ($rootPath): void {
    ...
    assertTrue(str_contains($routes,"'old'=>\$session->get('student_enrollments.old',[])"));
    assertTrue(str_contains($routes,"\$session->flash('student_enrollments.old'"));
...
$tests['carrega acompanhamento pedagógico e ações do AVA'] = static function () use ($rootPath): void {
    ...
    assertTrue(str_contains($console,'new PedagogicalSynchronizer($client,$repository,$connections,$inviter)'));
...
$tests['distribui e monitora versoes do plugin Mundo Inter'] = static function () use ($rootPath): void {
    ...
    assertSame('1.0.63',$metadata['release']);
...
$tests['personaliza o AVA compartilhado pela franquia e pelo Polo Presencial'] = static function () use ($rootPath): void {
    ...
    $routes=(string)file_get_contents($rootPath.'/routes/web.php');
    $view=(string)file_get_contents($rootPath.'/views/admin/platform/painel-inter.php');
    assertTrue(str_contains($version,"\$plugin->release = '1.0.63'"));
    ...
    assertTrue(str_contains($services,"'core_course_create_categories'"));
    assertTrue(str_contains($services,"'core_course_create_courses'"));
    assertTrue(str_contains($services,"'core_course_update_courses'"));
    ...
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'> .tile.spacer'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'.tile:not(.spacer)'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'max-width: none !important'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'mundointer-module-title-long'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'data-mundointer-number'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'mundointer-tile-book'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'mundointer-tile-assessment'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'.activityiconcontainer'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'grid-template-columns: 3.25rem minmax(0, 1fr)'));
    ...
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'mundointer-courseindex-active'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'color: #111827 !important'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'.courseindex-section-title.pageitem'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'setupMundoInterCourseIndexTools'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'mundointer-content-label'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'mundointer-content-note'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'.activity:not(.spacer)'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'[120, 450, 1000]'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'mundointerDynamicSections'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'border-bottom: 0 !important'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'mundointerMobileIndexClosed'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'mundointer-continue-button'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'mundointer-module-foot'));
    ...
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'mountedCourseIndex'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'mundointer:lastActivity:'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'Continuar de onde parou'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'mundointer-activity-navigation'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php'),'Voltar aos m\\u00f3dulos'));
...
$tests['carrega o Site Institucional com governança central por franquia'] = static function () use ($rootPath): void {
    ...
    $appLayout=(string)file_get_contents($rootPath.'/views/layouts/app.php');
    assertTrue(str_contains($appLayout,"filemtime(\$appScriptPath)"));
    assertTrue(str_contains($appLayout,'app.js?v=<?= $escape($appScriptVersion) ?>'));
...
$tests['prepara fornecedores externos e o Catalogo PRO sem misturar o financeiro'] = static function () use ($rootPath): void {
    ...
    assertTrue(str_contains($javascript,"params.get('section') || 'commercial'"));
    ...
    assertTrue(str_contains($view,'Loja de Cursos'));
    assertTrue(str_contains($view,'catalog-standard-tabs'));
    assertTrue(str_contains($view,'inter-access-form'));
...
$tests['publica Catalogo PRO por franquia com venda assistida'] = static function () use ($rootPath): void {
    ...
    assertTrue(str_contains($publicView,'data-back-to-top'));
    assertTrue(strpos($publicView,'.mobile-menu-button{display:none}') !== false);
    assertTrue(strpos($publicView,'.mobile-menu-button{display:none}') < strpos($publicView,'@media(max-width:1000px)'));
    assertTrue(str_contains($siteJs,'data-back-to-top'));
    ...
    assertTrue(str_contains($publicView,'focus-visible'));
    assertTrue(str_contains($courseView,'class="breadcrumb"'));
    assertTrue(str_contains($courseView,'cover-rating'));
    assertTrue(str_contains($siteJs,'data-hero-search'));
    assertTrue(str_contains($routes,"'/health'"));
    assertTrue(str_contains($routes,"'/{path:.*}'"));
    assertTrue(str_contains($routes,'site_404_logs'));
    assertTrue(str_contains($routes,"'testimonialRatings'=>"));
    assertTrue(is_file($rootPath.'/database/migrations/20260817_000030_create_site_404_logs.php'));
    assertTrue(str_contains($routes,"'/admin/site/not-found'"));
    assertTrue(str_contains($routes,"'/admin/site/not-found/clear'"));
    assertTrue(str_contains($routes,"'analytics_ga4_id'=>"));
    assertTrue(str_contains($routes,"'testimonials'=>"));
    assertTrue(is_file($rootPath.'/database/migrations/20260817_000040_add_ga4_to_organization_sites.php'));
    assertTrue(is_file($rootPath.'/database/migrations/20260817_000050_create_testimonial_invites.php'));
    assertTrue(str_contains($siteRepository,'function notFoundReport'));
    assertTrue(str_contains($siteRepository,'function clearNotFoundLogs'));
    assertTrue(str_contains($siteRepository,'function publishedTestimonialsForCourse'));
    assertTrue(str_contains($siteRepository,'analytics_ga4_id=:ga4_id'));
    assertTrue(is_file($rootPath.'/views/site/not-found.php'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/views/site/admin.php'),'/admin/site/not-found'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/views/site/admin.php'),'analytics_ga4_id'));
    assertTrue(str_contains($courseView,'O que dizem sobre este'));
    $consoleContent=(string)file_get_contents($rootPath.'/bin/console');
    assertTrue(str_contains($consoleContent,'sitemap:ping'));
    assertTrue(str_contains($consoleContent,'catalog:duplicates'));
    assertTrue(str_contains($consoleContent,'catalog:covers:audit'));
    assertTrue(str_contains($consoleContent,'CompletionTestimonialInviter'));
    assertTrue(is_file($rootPath.'/modules/Moodle/CompletionTestimonialInviter.php'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/modules/Moodle/PedagogicalSynchronizer.php'),'testimonialInviter'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/modules/Moodle/MoodleRepository.php'),'mc.fullname course_name'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/public/.htaccess'),'Content-Security-Policy'));
    ...
    assertTrue(str_contains((string)file_get_contents($rootPath.'/modules/Moodle/AvaBrandCatalog.php'),'ava_primary_color'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/views/admin/organizations/ava.php'),'name="ava_primary_color"'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/views/admin/organizations/ava.php'),'name="ava_logo"'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/views/admin/organizations/ava.php'),'enctype="multipart/form-data"'));
    ...
    assertTrue(str_contains((string)file_get_contents($rootPath.'/modules/Moodle/AvaBrandCatalog.php'),'site_url'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/modules/Moodle/AvaBrandCatalog.php'),'organization_domains dom'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/modules/Moodle/MoodleClient.php'),'function createSsoSession'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/modules/Moodle/MoodleClient.php'),'$parameters[\'slug\']=$slug'));
    ...
    assertTrue(str_contains((string)file_get_contents($pluginDir.'/version.php'),'2026081863'));
    assertTrue(str_contains((string)file_get_contents($pluginDir.'/version.php'),"'1.0.63'"));
    assertTrue(str_contains((string)file_get_contents($pluginDir.'/lib.php'),'global $USER, $PAGE, $DB;'));
    ...
    assertTrue(str_contains((string)file_get_contents($pluginDir.'/lib.php'),'Portal do Aluno</a>'));
    assertTrue(str_contains((string)file_get_contents($pluginDir.'/lib.php'),'mundointer-hero-block'));
    assertTrue(!str_contains((string)file_get_contents($pluginDir.'/lib.php'),'data-mi-nps'));
    assertTrue(str_contains((string)file_get_contents($pluginDir.'/portal.php'),'data-mi-course-stars'));
    assertTrue(!str_contains((string)file_get_contents($pluginDir.'/portal.php'),'mi-nps'));
    assertTrue(str_contains((string)file_get_contents($pluginDir.'/portal.php'),'Portal do Aluno'));
    ...
    assertTrue(str_contains($routes,'$client->updateUser('));
    ...
    assertTrue(str_contains($routes,"'/portal/aluno/ticket'"));
    assertTrue(str_contains($routes,"'/portal/aluno/document'"));
    assertTrue(str_contains($routes,'bank_slip_url,invoice_url'));
    assertTrue(str_contains($routes,'document_categories'));
    assertTrue(str_contains($routes,'academic_grade_percent'));
    assertTrue(str_contains($routes,'upcoming_payments'));
    assertTrue(str_contains($routes,'organization_announcements'));
    assertTrue(str_contains($routes,'organization_portal_settings'));
    assertTrue(str_contains($routes,'show_journey'));
    assertTrue(str_contains($routes,'expires_at'));
    assertTrue(str_contains($routes,'pixQrCode'));
    ...
    assertTrue(str_contains((string)file_get_contents($pluginDir.'/portal.php'),'Acessar</a>'));
    assertTrue(str_contains((string)file_get_contents($pluginDir.'/portal.php'),'mi-donut'));
    assertTrue(str_contains((string)file_get_contents($pluginDir.'/portal.php'),'Próximas parcelas'));
    ...
    assertTrue(str_contains((string)file_get_contents($pluginDir.'/portal.php'),'data-mi-ticket-form'));
    assertTrue(str_contains((string)file_get_contents($pluginDir.'/portal.php'),'data-mi-document-form'));
    assertTrue(str_contains((string)file_get_contents($pluginDir.'/portal.php'),'fa-wallet'));
    assertTrue(str_contains((string)file_get_contents($pluginDir.'/portal.php'),'fa-headset'));
    assertTrue(str_contains($routes,"hash_hmac('sha256','student-portal|"));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/modules/Organization/OrganizationPoleRepository.php'),'PORTAL_TOKEN_FIELD'));
    assertTrue(str_contains((string)file_get_contents($rootPath.'/modules/Moodle/AvaEnrollmentReleaser.php'),'student-portal|'));
    ...
    assertTrue(str_contains((string)file_get_contents($pluginDir.'/sso_login.php'),"new moodle_url('/local/mundointer/portal.php')"));
    ...
    assertTrue(str_contains((string)file_get_contents($pluginDir.'/db/upgrade.php'),'2026081863'));
...
$tests['migra o Catalogo MASTER para LTI 1.3 sem perder o legado'] = static function () use ($rootPath): void {
    ...
    $pluginSelections=(string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/classes/external/lti_selections.php');
    ...
    assertTrue(str_contains($pluginVersion,'1.0.63'));
...
$tests['homologa catalogo em amostra assistida sem gerar cobranca'] = static function () use ($rootPath): void {
    ...
    assertTrue(str_contains($view,':homologation"'));
...
$tests['separa catalogos trilhas mundo inter e publicacao no AVA'] = static function () use ($rootPath): void {
    ...
    assertTrue(str_contains($providers,'_catalog-standard-overviews.php'));
...
$tests['organiza novas matriculas em uma coorte por franquia e turmas no AVA'] = static function () use ($rootPath): void {
    ...
    assertTrue(str_contains($pluginVersion,"release = '1.0.63'"));
...
$tests['publica trilhas no AVA com curso unico e historico'] = static function () use ($rootPath): void {
    ...
    $pluginLib=(string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/lib.php');
    ...
    $categoryManager=(string)file_get_contents($rootPath.'/modules/Moodle/MoodleAcademicCategoryManager.php');
    assertTrue(str_contains($categoryManager,"'MUNDO INTER','mi-mundo-inter'"));
    ...
    assertTrue(str_contains($repository,'source_remote_course_id'));
    ...
    assertTrue(str_contains($publisher,"\$section['sourcecourseid']=\$sourceCourseId"));
    assertTrue(str_contains($publisher,"['book_and_materials','lessons','official_assessment']"));
    assertTrue(str_contains($pluginSections,'sync_master_course_module'));
    assertTrue(str_contains($pluginSections,"array_merge(\$buckets['book'],\$buckets['lesson'],\$buckets['assessment'])"));
    assertTrue(str_contains($pluginSections,"'AVP - Avaliação: '.\$name"));
    ...
    assertTrue(str_contains($pluginSections,'sync_trail_subtitle'));
    assertTrue(str_contains($pluginSections,'core_text::strtoupper(trim($title))'));
    assertTrue(str_contains($pluginSections,"'class'=>'mundointer-subtitle'"));
    ...
    assertTrue(str_contains($pluginSections,"'completion'=>COMPLETION_TRACKING_NONE"));
    assertTrue(str_contains($pluginSections,"array_merge([\$booklabel['cmid']],\$bookcmids,\$materialcmids,\$lessonsequence,[\$assessmentlabel['cmid']],\$assessmentcmids)"));
    ...
    assertTrue(str_contains($pluginSections,"\$seen=['book'=>[],'lesson'=>[],'assessment'=>[]]"));
    assertTrue(str_contains($pluginSections,'$activitykind='));
    assertTrue(str_contains($pluginSections,"preg_match('/livro|apostila|material/u',\$activityname)"));
    assertTrue(str_contains($pluginSections,"'visibleoncoursepage',0"));
    assertTrue(str_contains($pluginSections,'!isset($hiddencmids[$cmid])'));
    assertTrue(!str_contains($pluginSections,'Formação:'));
    assertTrue(!str_contains($pluginSections,'Conteúdo no AVA Cursos'));
    assertTrue(!str_contains($pluginSections,'Bloco sincronizado automaticamente pelo Mundo Inter.'));
    assertTrue(str_contains($pluginSections,'rebuild_course_cache'));
    assertTrue(str_contains($pluginSections,"'course','overviewfiles'"));
    assertTrue(str_contains($pluginSections,"'course','overviewfiles',null"));
    assertTrue(str_contains($pluginSections,'imagejpeg'));
    assertTrue(str_contains($pluginSections,"\$extension='jpg'"));
    assertTrue(str_contains($pluginSections,'mundointer-course-banner:start'));
    assertTrue(str_contains($publisher,"'course_cover'"));
    assertTrue(str_contains($publisher,"'/catalog-media/'"));
...
$tests['transforma disciplina master em curso individual reutilizavel'] = static function () use ($rootPath): void {
    $publisher=(string)file_get_contents($rootPath.'/modules/Catalog/AvaCatalogPublisher.php');
    $providerRepository=(string)file_get_contents($rootPath.'/modules/Catalog/CourseProviderRepository.php');
    $catalogRepository=(string)file_get_contents($rootPath.'/modules/Catalog/LearningCatalogRepository.php');
    $client=(string)file_get_contents($rootPath.'/modules/Moodle/MoodleClient.php');
    $routes=(string)file_get_contents($rootPath.'/routes/web.php');
    ...
    assertTrue(str_contains($publisher,"ensureFormation('MASTER')"));
    ...
    assertTrue(str_contains($providerView,'Aulas e recursos deste Módulo'));
    ...
    assertTrue(str_contains($pluginExternal,"'Módulo ' . \$modulenumber"));
    assertTrue(str_contains($pluginExternal,"'Livro e Materiais Interativos'"));
    assertTrue(str_contains($pluginExternal,'order_groups(self::group_sources'));
    assertTrue(str_contains($pluginExternal,'return array_merge($books, $lessons, $assessments)'));
    assertTrue(str_contains($pluginExternal,'is_complete_book_group'));
...
$tests['organiza catalogos em formacoes modulos e trilhas no moodle'] = static function () use ($rootPath): void {
    ...
    assertTrue(str_contains($manager,"\$modulesIdNumber='mi-formacao-'"));
    ...
    assertTrue(str_contains($client,'core_course_update_categories'));
    assertTrue(str_contains($client,'public function moveCourse'));
    assertTrue(str_contains($publisher,"ensureFormation('MASTER')"));
    assertTrue(str_contains($publisher,'ensureMasterCategory'));
    assertTrue(str_contains($services,"'core_course_update_categories'"));
};

$tests['separa selecoes master por avaliacao e ignora cursos definitivos'] = static function () use ($rootPath): void {
    $selections=(string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/classes/external/lti_selections.php');
    $materializer=(string)file_get_contents($rootPath.'/integrations/moodle/local_mundointer/classes/external/materialize_lti_course.php');

    assertTrue(str_contains($selections,'selectionSegments'));
    assertTrue(str_contains($selections,'selectionName'));
    assertTrue(str_contains($selections,'isSelectionStartName'));
    assertTrue(str_contains($selections,'isAdjacentSelectionHeader'));
    assertTrue(str_contains($selections,'selectionTitleFromHeader'));
    assertTrue(str_contains($selections,'FIND_IN_SET(cm.id,cs.sequence)'));
    assertTrue(str_contains($selections,'$selectionstarted'));
    assertTrue(str_contains($selections,"'-segment-' . \$segment"));
    assertTrue(str_contains($selections,"str_starts_with(\$courseidnumber, 'mi-master-course-')"));
    assertTrue(str_contains($materializer,'selection_for_source'));
    assertTrue(str_contains($materializer,'is_selection_start_name'));
    assertTrue(str_contains($materializer,'is_adjacent_selection_header'));
    assertTrue(str_contains($materializer,'book_activity_display_name'));
    assertTrue(str_contains($materializer,"'Livro - ' . trim(\$coursename)"));
    assertTrue(str_contains($materializer,"'Materiais Interativos'"));
    assertTrue(str_contains($materializer,"/^(?:nome\\s+do\\s+)?livro"));
    assertTrue(str_contains($materializer,'$bookhasexplicitname'));
    assertTrue(str_contains($materializer,'$itemindex === $itemcount'));
    assertTrue(str_contains($materializer,'ensure_materials_index'));
    assertTrue(str_contains($materializer,"'mi-master-materials-index-'"));
    assertTrue(str_contains($materializer,'Acesse os materiais interativos organizados por módulo.'));
    assertTrue(str_contains($materializer,'A seleção MASTER desta disciplina'));
};

$tests['fecha piloto master com curadoria avaliacao e publicacao revisada'] = static function () use ($rootPath): void {
    $migration=(string)file_get_contents($rootPath.'/database/migrations/20260813_000030_create_provider_course_assessments.php');
    $repository=(string)file_get_contents($rootPath.'/modules/Catalog/CourseProviderRepository.php');
    ...
    assertTrue(str_contains($migration,'CREATE TABLE provider_course_assessments'));
    assertTrue(str_contains($migration,'UNIQUE KEY provider_course_assessments_course_uq'));
    assertTrue(str_contains($repository,'saveMasterCopy'));
    ...
    assertTrue(str_contains($pluginExternal,"'AVP - Avaliação: '"));
    assertTrue(str_contains($pluginExternal,'is_assessment_name'));
    assertTrue(str_contains($pluginExternal,'assessment_display_name'));
    assertTrue(str_contains($pluginShared,'public static function apply_managed_assessment'));
    assertTrue(str_contains($pluginShared,'public static function apply_managed_course_format'));
    assertTrue(str_contains($pluginShared,"'defaulttileicon'=>'pie-chart'"));
...
$tests['prepara curso MASTER automaticamente antes da matricula'] = static function () use ($rootPath): void {
    ...
    assertTrue(str_contains($browserRobot,'activityName.isVisible()'));
