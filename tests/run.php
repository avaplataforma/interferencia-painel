...
$tests['publica Catalogo PRO por franquia com venda assistida'] = static function () use ($rootPath): void {
    ...
    assertTrue(str_contains((string)file_get_contents($pluginDir.'/version.php'),'2026081800'));
    ...
    assertTrue(str_contains((string)file_get_contents($pluginDir.'/lib.php'),'mundointer-support-float'));
    ...
    assertTrue(str_contains((string)file_get_contents($pluginDir.'/db/upgrade.php'),'2026081800'));
