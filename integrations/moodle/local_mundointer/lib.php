...
.mundointer-mycourses-contacts a.mi-secretaria {
    background: #fff;
    color: var(--mundointer-primary);
    border: 1px solid color-mix(in srgb, var(--mundointer-primary) 45%, #dce3e8);
}
.mundointer-mycourses-contacts a.mi-secretaria:hover {
...
function local_mundointer_before_standard_top_of_body_html(): string
{
    ...
    if ($isMyCourses || $isCourseView || $isActivityView) {
        ...
        $hero = '<header class="mundointer-mycourses-hero" id="mundointer-mycourses-hero">'
            . $heroLogo
...
function hideMundoInterCourseExtras() {
  ...
  function mountMundoInterCoursesHero() {
    var miHero = document.getElementById("mundointer-hero-block");
    if (!miHero) {
      return;
    }
