...
final readonly class LineRepository
{
    ...
    public function save(?int $id,int $unitId,string $name,string $phone,bool $active,array $userIds):int
    {
