...
final readonly class IntegrationRepository
{
    ...
    /** @return array{base_url:string,token:string,token_last4:string,is_active:bool,configured:bool,sync_cursor:int,sync_complete:bool,last_tested_at:?string,last_synced_at:?string,last_error:?string} */
