...
final readonly class SpacesStorageManager
{
    ...
    public function documentTypes():DocumentTypeRepository{return new DocumentTypeRepository($this->repository->database());}
    public function documents():DocumentManager{return new DocumentManager($this->repository->database(),$this,$this->documentTypes());}
