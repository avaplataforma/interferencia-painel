...
final readonly class SiteRepository
{
    ...
    public function saveContent(int $organizationId,array $data,array $productIds):void
    {
        ...
        $values=[
            ...
            'footer_text'=>$this->text($data['footer_text']??'',500,'texto do rodapé'),
