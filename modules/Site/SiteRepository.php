...
final readonly class SiteRepository
{
    ...
    public function saveContent(int $organizationId,array $data,array $productIds):void
    {
        ...
        $values=[
            ...
            'about_mission'=>$this->text($data['about_mission']??'',2000,'missão'),'about_vision'=>$this->text($data['about_vision']??'',2000,'visão'),'about_values'=>$this->text($data['about_values']??'',2000,'valores'),
