 ...
 <form class="organization-ava-form" method="post" enctype="multipart/form-data" action="<?= $escape($basePath) ?>/admin/organizations/<?= (int)$organization['id'] ?>/ava"><?= $csrfField ?>
  <div class="ava-communication-card">
   ...
   <div class="organization-fields">
    ...
    <label class="field-third">Logo do Login<input type="file" name="ava_logo" accept="image/png,image/jpeg,image/webp,image/svg+xml"><?php if($brandAsset($organization['logo_path']??null)!==''):?><span class="ava-brand-preview"><img src="<?= $escape($brandAsset($organization['logo_path'])) ?>" alt="Logo do Login atual"></span><?php else:?><small>Nenhuma imagem enviada ainda.</small><?php endif;?></label>
    <label class="field-third">Logo da Barra<input type="file" name="ava_navbar_logo" accept="image/png,image/jpeg,image/webp,image/svg+xml"><?php if($brandAsset($organization['ava_navbar_logo_path']??null)!==''):?><span class="ava-brand-preview"><img src="<?= $escape($brandAsset($organization['ava_navbar_logo_path'])) ?>" alt="Logo da Barra atual"></span><?php else:?><small>Se vazia, a barra usa o favicon.</small><?php endif;?></label>
    <label class="field-third">Favicon<input type="file" name="ava_favicon" accept="image/png,image/jpeg,image/webp,image/svg+xml"><?php if($brandAsset($organization['favicon_path']??null)!==''):?><span class="ava-brand-preview"><img src="<?= $escape($brandAsset($organization['favicon_path'])) ?>" alt="Favicon atual"></span><?php else:?><small>Nenhuma imagem enviada ainda.</small><?php endif;?></label>
