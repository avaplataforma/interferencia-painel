...
@media(max-width:780px){.integration-hero{align-items:flex-start;flex-direction:column}.integration-grid{grid-template-columns:1fr}.integration-card.is-wide{grid-column:auto}.integration-card{grid-template-columns:auto minmax(0,1fr);grid-template-areas:"icon status" "copy copy" "arrow arrow";min-height:0}.integration-arrow{justify-self:end}}
</style>
