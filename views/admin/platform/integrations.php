...
<div class="integration-hub">
 <header class="integration-hero">
  ...
  <div class="integration-count"><i class="fa-solid fa-plug-circle-bolt"></i><div><strong>6 integrações</strong><small>Gestão centralizada</small></div></div>
 </header>
 ...
 <section class="integration-grid" aria-label="Integrações do ADM Central">
  ...
  <a class="integration-card email" href="<?= $escape($basePath) ?>/admin/platform/integrations/email">
   <span class="integration-icon"><i class="fa-solid fa-envelope-open-text"></i></span>
   <span class="integration-copy"><span class="integration-kicker">Comunicação transacional</span><strong>E-mail Central</strong><small>Envios de acesso, cobranças e notificações com identidade e domínio autenticado de cada franquia.</small></span>
   <span class="integration-state <?= $emailConfigured&&$emailActive?'is-ready':'is-pending' ?>"><i class="fa-solid <?= $emailConfigured&&$emailActive?'fa-circle-check':'fa-clock' ?>"></i><?= $emailConfigured&&$emailActive?'Ativa':'Configuração pendente' ?></span>
   <span class="integration-arrow"><i class="fa-solid fa-arrow-right"></i></span>
  </a>
