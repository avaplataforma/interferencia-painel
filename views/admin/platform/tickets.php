...
<?php foreach($tickets as$ticket):?><tr><td><strong>#<?= $escape($ticket['ticket_ref']) ?> · <?= $escape($ticket['subject']) ?></strong><br><small><?= $escape($ticket['unit_name']) ?></small><?php if(!empty($ticket['franchise_application_id'])):?><br><a href="<?= $escape($basePath) ?>/admin/franchise-applications/<?= (int)$ticket['franchise_application_id'] ?>">Analisar solicitação</a><?php endif;?></td><td><?= $escape($ticket['organization_name']) ?></td><td><?= $escape($ticket['requester_name']) ?></td><td><?= $escape($ticket['department_name']) ?></td><td><?= $escape($priorityLabels[$ticket['priority']]??$ticket['priority']) ?></td><td><?= $escape($statusLabels[$ticket['status']]??$ticket['status']) ?></td><td><?= $escape(date('d/m/Y H:i',strtotime((string)$ticket['updated_at']))) ?></td></tr><?php endforeach; ?>
