...
$standardCombinedModuleCount = $standardCourseCount + $standardModuleCount;
?>
<nav class="catalog-subtabs catalog-standard-tabs" role="tablist" aria-label="Áreas da Formação">
 <button class="catalog-subtab is-active" type="button" data-catalog-subtab="commercial" data-provider="<?= $escape($provider) ?>"><i class="fa-solid fa-store"></i> Loja de Cursos <span><?= $standardCommercialCount ?></span></button>
 <button class="catalog-subtab" type="button" data-catalog-subtab="modules" data-provider="<?= $escape($provider) ?>"><i class="fa-solid fa-cubes-stacked"></i> Módulos <span><?= $standardCombinedModuleCount ?></span></button>
