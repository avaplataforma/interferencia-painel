...
<section class="admin-links integrations-grid">
  ...
  <?php if($navigation['moodle_settings']??false):?><a class="admin-link" href="<?= $escape($basePath) ?>/admin/ava"><span class="quick-icon"><i class="fa-solid fa-graduation-cap"></i></span><span><strong>AVA</strong><small>Cursos, usuários, matrículas e liberações especiais</small></span><i class="fa-solid fa-chevron-right"></i></a><?php endif;?>
</section>
