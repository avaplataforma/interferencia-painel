...
<section class="card pedagogical-card">
  <div class="card-body">
    ...
    <form class="pedagogical-filters mb-3" method="get" action="<?= $escape($basePath) ?>/students/pedagogical">
      <label class="pedagogical-filter-field pedagogical-filter-search"><span>Pesquisar</span><div class="pedagogical-input-icon"><i class="fa-solid fa-magnifying-glass" aria-hidden="true"></i><input name="q" value="<?= $escape($search) ?>" placeholder="Aluno, CPF ou curso"></div></label>
