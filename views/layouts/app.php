  ...
  <div class="app-shell d-flex">
    <aside class="sidebar desktop-sidebar flex-shrink-0 p-3">
      ...
      <nav class="nav flex-column gap-1">
        ...
        <?php if ($navigation['crm'] ?? false): ?><details class="nav-group" <?= $crmOpen ? 'open' : '' ?>><summary><span><i class="fa-solid fa-chart-line fa-fw" aria-hidden="true"></i>CRM</span></summary><div class="nav-submenu"><a class="nav-link" href="<?= $escape($basePath) ?>/crm/contacts"><i class="fa-solid fa-user-tag fa-fw" aria-hidden="true"></i>Leads</a><a class="nav-link" href="<?= $escape($basePath) ?>/crm/follow-ups"><i class="fa-solid fa-calendar-check fa-fw" aria-hidden="true"></i>Follow-ups</a></div></details><?php endif; ?>
        <?php if ($navigation['whatsapp'] ?? false): ?><a class="nav-link" href="<?= $escape($basePath) ?>/whatsapp"><i class="fa-solid fa-comments fa-fw" aria-hidden="true"></i>WhatsApp<?php if((int)($whatsappAlerts['unread']??0)>0):?><span class="nav-count" data-whatsapp-count><?= (int)$whatsappAlerts['unread'] ?></span><?php endif;?></a><?php endif; ?>
        <?php if ($navigation['finance'] ?? false): ?><details class="nav-group" <?= $studentsOpen ? 'open' : '' ?>><summary><span><i class="fa-solid fa-graduation-cap fa-fw" aria-hidden="true"></i>Alunos</span></summary><div class="nav-submenu"><a class="nav-link" href="<?= $escape($basePath) ?>/finance/customers"><i class="fa-solid fa-address-card fa-fw" aria-hidden="true"></i>Cadastro</a><?php if ($navigation['finance_manage'] ?? false): ?><a class="nav-link" href="<?= $escape($basePath) ?>/students/enrollments"><i class="fa-solid fa-graduation-cap fa-fw" aria-hidden="true"></i>Matrículas</a><?php endif; ?><?php if($navigation['moodle_settings']??false):?><a class="nav-link" href="<?= $escape($basePath) ?>/students/moodle-reconciliation"><i class="fa-solid fa-link fa-fw" aria-hidden="true"></i>Conciliação Moodle</a><?php endif;?></div></details><?php endif; ?>
        <?php if ($navigation['tickets'] ?? false): ?><a class="nav-link" href="<?= $escape($basePath) ?>/tickets"><i class="fa-solid fa-ticket fa-fw" aria-hidden="true"></i>Tickets<?php if((int)($ticketAlerts['unread']??0)>0):?><span class="nav-count" data-ticket-count><?= (int)$ticketAlerts['unread'] ?></span><?php endif;?></a><?php endif; ?>
        ...
        <div class="adm-extensions"><?php if ($navigation['finance_products'] ?? false): ?><a class="nav-link adm-extension" href="<?= $escape($basePath) ?>/admin/finance/products"><i class="fa-solid fa-book-open fa-fw" aria-hidden="true"></i>Cursos e preços</a><?php endif; ?><?php if ($navigation['finance_settings'] ?? false): ?><a class="nav-link adm-extension" href="<?= $escape($basePath) ?>/admin/integrations/asaas"><i class="fa-solid fa-key fa-fw" aria-hidden="true"></i>Integração Asaas</a><?php endif; ?><?php if ($navigation['moodle_settings'] ?? false): ?><a class="nav-link adm-extension" href="<?= $escape($basePath) ?>/admin/integrations/moodle"><i class="fa-solid fa-graduation-cap fa-fw" aria-hidden="true"></i>Integração Moodle</a><?php endif; ?></div>
      </nav>
    </aside>
