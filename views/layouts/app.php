...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .tag-dropdown > summary { padding: .72rem; border: 1px solid #bcc6ce; border-radius: .55rem; background: #fff; cursor: pointer; list-style-position: inside; }
