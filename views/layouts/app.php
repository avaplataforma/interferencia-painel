...
$admOpen = preg_match('#/(users|units|roles|tags|statuses|external-forms)(?:/|$)#', $currentPath) === 1 || str_contains($currentPath, '/whatsapp/lines') || str_contains($currentPath, '/whatsapp/templates');
?>
<!doctype html>
<html lang="pt-BR">
<head>
  ...
  <div class="app-shell d-flex">
    <aside class="sidebar desktop-sidebar flex-shrink-0 p-3">
      ...
      <nav class="nav flex-column gap-1">
        ...
        <?php if ($navigation['finance'] ?? false): ?><a class="nav-link" href="<?= $escape($basePath) ?>/finance"><i class="fa-solid fa-wallet fa-fw" aria-hidden="true"></i>Financeiro</a><?php endif; ?>
        ...
        <?php if ($navigation['finance_settings'] ?? false): ?><a class="nav-link" href="<?= $escape($basePath) ?>/admin/integrations/asaas"><i class="fa-solid fa-key fa-fw" aria-hidden="true"></i>ADM · Integração Asaas</a><?php endif; ?>
      </nav>
    </aside>
