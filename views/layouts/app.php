...
$admOpen = preg_match('#/(users|units|roles|tags|statuses|external-forms)(?:/|$)#', $currentPath) === 1;
?>
<!doctype html>
<html lang="pt-BR">
<head>
