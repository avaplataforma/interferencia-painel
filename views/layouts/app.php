...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .nav-submenu-label { display: flex; align-items: center; gap: .55rem; padding: .45rem .7rem .25rem; color: #87929c; font-size: .73rem; font-weight: 800; letter-spacing: .055em; text-transform: uppercase; }
    .nav-submenu-label i { color: var(--inter-accent); }
  ...
  <div class="app-shell d-flex">
    <aside class="sidebar desktop-sidebar flex-shrink-0 p-3">
      ...
      <nav class="nav flex-column gap-1">
        ...
        <?php if ($navigation['finance'] ?? false): ?><details class="nav-group" <?= $studentsOpen ? 'open' : '' ?>><summary><span><i class="fa-solid fa-graduation-cap fa-fw" aria-hidden="true"></i>Alunos</span></summary><div class="nav-submenu"><span class="nav-submenu-label"><i class="fa-solid fa-wallet fa-fw" aria-hidden="true"></i>Financeiro</span><a class="nav-link" href="<?= $escape($basePath) ?>/finance/customers"><i class="fa-solid fa-users fa-fw" aria-hidden="true"></i>Clientes</a><a class="nav-link" href="<?= $escape($basePath) ?>/finance/payments"><i class="fa-solid fa-file-invoice-dollar fa-fw" aria-hidden="true"></i>Cobranças</a><a class="nav-link" href="<?= $escape($basePath) ?>/finance/subscriptions"><i class="fa-solid fa-arrows-rotate fa-fw" aria-hidden="true"></i>Assinaturas</a></div></details><?php endif; ?>
