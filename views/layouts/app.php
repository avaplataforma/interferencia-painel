  ...
  <div class="app-shell d-flex">
    <aside class="sidebar desktop-sidebar flex-shrink-0 p-3">
      ...
      <nav class="nav flex-column gap-1">
        ...
        <?php if ($navigation['whatsapp'] ?? false): ?><a class="nav-link" href="<?= $escape($basePath) ?>/whatsapp"><i class="fa-solid fa-comments fa-fw" aria-hidden="true"></i>WhatsApp</a><?php endif; ?>
...
<script src="<?= $escape($basePath) ?>/assets/js/app.js?v=5"></script>
</body>
</html>
