  ...
  <div class="app-shell d-flex">
    <aside class="sidebar desktop-sidebar flex-shrink-0 p-3">
      ...
      <nav class="nav flex-column gap-1">
        ...
        <?php if ($navigation['finance'] ?? false): ?><details class="nav-group" <?= $studentsOpen ? 'open' : '' ?>><summary><span><i class="fa-solid fa-graduation-cap fa-fw" aria-hidden="true"></i>Alunos</span></summary><div class="nav-submenu"><?php if ($navigation['finance_manage'] ?? false): ?><a class="nav-link" href="<?= $escape($basePath) ?>/finance/customers/create"><i class="fa-solid fa-user-graduate fa-fw" aria-hidden="true"></i>Cadastro</a><?php endif; ?><a class="nav-link" href="<?= $escape($basePath) ?>/finance/customers"><i class="fa-solid fa-wallet fa-fw" aria-hidden="true"></i>Financeiro</a><?php if($navigation['moodle_settings']??false):?><a class="nav-link" href="<?= $escape($basePath) ?>/students/moodle-reconciliation"><i class="fa-solid fa-link fa-fw" aria-hidden="true"></i>Conciliação Moodle</a><?php endif;?></div></details><?php endif; ?>
