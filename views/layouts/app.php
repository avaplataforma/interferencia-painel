...
$admOpen = preg_match('#/(users|units|roles|tags|statuses|external-forms)(?:/|$)#', $currentPath) === 1 || str_contains($currentPath, '/whatsapp/lines') || str_contains($currentPath, '/whatsapp/templates') || str_contains($currentPath, '/admin/integrations');
...
<head>
  ...
  <style>
    .nav-group:not([open]) + .adm-extension { display: none; }
  ...
  <div class="app-shell d-flex">
    <aside class="sidebar desktop-sidebar flex-shrink-0 p-3">
      ...
      <nav class="nav flex-column gap-1">
        ...
        <?php if ($navigation['finance_settings'] ?? false): ?><a class="nav-link adm-extension" href="<?= $escape($basePath) ?>/admin/integrations/asaas"><i class="fa-solid fa-key fa-fw" aria-hidden="true"></i>Integração Asaas</a><?php endif; ?>
      </nav>
    </aside>
