...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    @media(max-width:991.98px){.whatsapp-workspace{grid-template-columns:minmax(17rem,21rem) 1fr}.contact-panel{display:none}}@media(max-width:575.98px){.whatsapp-heading{align-items:flex-start;flex-direction:column}.whatsapp-workspace{grid-template-columns:1fr}.chat-panel{min-height:32rem}.conversation-list{max-height:19rem}}
